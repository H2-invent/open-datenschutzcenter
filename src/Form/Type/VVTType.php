...
class VVTType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('loeschfrist', TextareaType::class, ['attr' => ['readonly'=>true], 'label' => 'Löschfrist', 'required' => false, 'translation_domain' => 'form', 'help' => 'Alte Löschfristen. Bitte in Löschkonzepte umziehen.'])
