...
RED='\033[0;31m'
NC='\033[0m' # No Color
printf "Browse to ${RED}%s://%s${NC} and visit your own open-datenschutzcenter\n" $HTTP_METHOD $PUBLIC_URL
...
printf "Have fun with your open-datenschutzcenter and give us a star on github. https://github.com/H2-invent/open-datenschutzcenter/\n"
